...
class Graduation(models.Model):
    ...
    alumni = models.ForeignKey(
        Alumni, on_delete=models.CASCADE, related_name='graduation')
...
class Job(models.Model):
    alumni = models.ForeignKey(
        Alumni, on_delete=models.CASCADE, related_name='work')
    company = models.ForeignKey(
        Company, on_delete=models.CASCADE, default="", related_name='company')
