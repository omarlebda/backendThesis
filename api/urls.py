...
from .views import AlumniList, AlumniDetail, AlumniEdit, APIGraduationCreateView, APIGraduationUpdateDeleteView, APIGraduationProjectCreateView, APIGraduationProjectUpdateDeleteView, APIJobCreateView, APIJobEditDeleteView, APICompanyCreateView, CompanyList
urlpatterns = [
